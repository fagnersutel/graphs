...
colnames(data)=c("Veiculos" , "Pedestres" , "Transp Coletivo" , "Bike" , "Seletivo" )
rownames(data)=paste("Bairro" , letters[1:3] , sep="-")
...
radarchart( data  , axistype=1 ,
            ...
            #custom the grid
            cglcol="grey", cglty=1, axislabcol="red", caxislabels=seq(0,20,5), cglwd=0.8,
            #custom labels
            vlcex=0.9
)
...
colnames(data)=c("Veiculos" , "Pedestres" , "Transp Coletivo" , "Seletivo" , "Uber", "Taxi" , "Carona" , "Outros", "Skate", "Local" )
